...
<br/>
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="http://bem.fe.unsri.ac.id/" class="portfolio-link" data-toggle="modal" target="_blank"> 
                        <div class="caption">
                ...
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="http://bem-fh.unsri.ac.id/" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        ...
                        <h4>BEM Fakultas Hukum</h4>
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="https://www.facebook.com/BemKmFtUniversitasSriwijaya" class="portfolio-link" data-toggle="modal"  target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item logo_bemf logo_bemf">
                    <a href="www.fkunsribem.wix.com/fkunsribem" class="portfolio-link" data-toggle="modal"  target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="https://www.facebook.com/bemkmfp.unsri" class="portfolio-link" data-toggle="modal" target="_blank">
                            <div class="caption">
                                <div class="caption-content">
                                    <i class="fa fa-search-plus fa-3x"></i>
                                </div>
                            </div>
                            <img src="logo/BEMFP2.png" class="logo_img" class="img-responsive" alt=""/> 
                            <h4>BEM KM Fakultas Pertanian</h4>
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="https://www.facebook.com/bemkm.fkipunsri" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="https://www.facebook.com/profile.php?id=100008452332526&fref=ts" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="https://www.facebook.com/bemfmipa.unsri?fref=ts" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="logo/BEMFMIPA2.png" class="logo_img" class="img-responsive" alt=""/> 
                        <h4 style="font-size: 17px;">BEM KM Fakultas<br/> Matematika dan Ilmu Pengetahuan Alam</h4>
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="http://bem.ilkom.unsri.ac.id/" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-sm-4 portfolio-item logo_bemf">
                    <a href="http://www.bem.fkm.unsri.ac.id/" class="portfolio-link" data-toggle="modal" target="_blank">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
